...
from xc_cache.data.cross_attn.datasets_loader import DatasetWithContext


class XCCACHEDatasetWithContext(Dataset):
    def __init__(
        self,
        train_dataset,
        tokenizer,
    ...
    def __getitem__(self, i: int):
        ...
        # This code is based on research-xc_cache: tulu2_prompt_format()
        answer = d.get("answer", "")
...
def xc_cache_data_prep(
    ...
    if cross_format:
        ...
        training_data = XCCACHEDatasetWithContext(filtered_ds["train"], tokenizer, context_length)
    ...
    for data_name in dataset_names:
        ...
        if cross_format:
            ...
            validation_data[data_name] = XCCACHEDatasetWithContext(
