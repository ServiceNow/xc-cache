...
from xc_cache.metrics.generation.metrics import F1, EM, Precision, Recall
import tqdm
...
def process_inputs(
    *,
    ...
    """This function takes as input a batch of data as output by an instance of xc_cache.data.cross_attn.data_processors.Collator,
